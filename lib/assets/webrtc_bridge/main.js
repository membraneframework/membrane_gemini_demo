export function init(ctx, initial) {
  ...
  // Bubble each peer connection's aggregate state (ICE + DTLS) up to the
  // Elixir bridge, which fans it out to subscribers. "connected" is the
  // moment the DTLS handshake has finished and media can flow.
